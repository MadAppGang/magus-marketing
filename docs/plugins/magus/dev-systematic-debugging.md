...
**5 reference documents, about 1,840 lines.**
...
| [`workflow.md`](https://github.com/MadAppGang/magus/blob/main/plugins/dev/skills/discipline/systematic-debugging/workflow.md) | Standard Debug Workflow | 441 |
